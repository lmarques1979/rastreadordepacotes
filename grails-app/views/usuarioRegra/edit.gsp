...
<html>
	<head>
		...
		<title><g:message code="edit.usuarioregra.label"/></title>
	</head>
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				<li><g:link class="list" action="index"><g:message code="list.usuarioregra.label"/></g:link></li>
		...
		<div id="edit-usuarioRegra" class="content scaffold-edit" role="main">
			<h1><g:message code="edit.usuarioregra.label" args="[entityName]" /></h1>
