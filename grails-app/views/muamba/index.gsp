		...
		<div id="list-muamba" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="codigo" title="${message(code: 'muamba.codigo.label', default: 'Codigo Rastreio')}" />
						<g:sortableColumn property="pais" title="${message(code: 'muamba.pais.label', default: 'País')}" />
						<g:sortableColumn property="descricao" title="${message(code: 'muamba.descricao.label', default: 'Descricao')}" />
			...
			<g:if test="${muambaInstanceCount > 0 }">
