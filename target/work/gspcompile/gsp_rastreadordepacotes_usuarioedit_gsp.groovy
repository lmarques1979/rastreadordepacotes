...
class gsp_rastreadordepacotes_usuarioedit_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',7,['code':("edit.usuario.label")],-1)
})
...
printHtmlPart(4)
invokeTag('message','g',13,['code':("edit.usuario.label")],-1)
printHtmlPart(5)
...
invokeTag('form','g',32,['url':([resource:usuarioInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(20)
})
