...
class gsp_rastreadordepacotes_paisedit_gsp extends GroovyPage {
...
printHtmlPart(4)
createTagBody(2, {->
invokeTag('message','g',13,['code':("list.pais.label")],-1)
})
...
invokeTag('eachError','g',26,['bean':(paisInstance),'var':("error")],3)
printHtmlPart(17)
})
invokeTag('hasErrors','g',28,['bean':(paisInstance)],2)
printHtmlPart(10)
createTagBody(2, {->
printHtmlPart(18)
invokeTag('hiddenField','g',30,['name':("version"),'value':(paisInstance?.version)],-1)
printHtmlPart(19)
...
invokeTag('form','g',37,['url':([resource:paisInstance, action:'update']),'method':("PUT")],2)
printHtmlPart(22)
})
