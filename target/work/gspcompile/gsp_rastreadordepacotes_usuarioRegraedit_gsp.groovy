...
class gsp_rastreadordepacotes_usuarioRegraedit_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',7,['code':("edit.usuarioregra.label")],-1)
})
...
printHtmlPart(6)
invokeTag('message','g',18,['code':("edit.usuarioregra.label"),'args':([entityName])],-1)
printHtmlPart(7)
