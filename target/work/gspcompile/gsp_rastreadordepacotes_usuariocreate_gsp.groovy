...
class gsp_rastreadordepacotes_usuariocreate_gsp extends GroovyPage {
...
createTagBody(2, {->
createTagBody(3, {->
invokeTag('message','g',6,['code':("create.usuario.label")],-1)
})
...
printHtmlPart(4)
invokeTag('message','g',12,['code':("create.usuario.label"),'args':([entityName])],-1)
printHtmlPart(5)
...
invokeTag('form','g',30,['url':([resource:usuarioInstance, action:'save'])],2)
printHtmlPart(19)
})
